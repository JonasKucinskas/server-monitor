    ...
    public class PartitionData
    {
        ...
        public static Dictionary<string, PartitionData> SampleNetworkData()
        {
            ...
            foreach (var line in File.ReadLines("/proc/diskstats"))
            {
                ...
                //if (partition.Name == "sda2"){
                //    Console.WriteLine("reads " + partition.Reads);
                //    Console.WriteLine("readsectors " + partition.ReadSectors);
                //    Console.WriteLine("writes " + partition.Writes);
                //    Console.WriteLine("writeSector " + partition.WriteSectors); 
                //    Console.WriteLine("iostime " + partition.IoTime);
                //    Console.WriteLine("nameweightiedioteim " + partition.WeightedIoTime);
                //    Console.WriteLine();
                //}
